...
import { Document, CreateDocumentResponse, DeleteDocumentRequest, FetchAllDocumentsResponse, FetchDocumentRequest, SaveDocumentRequest, FetchDocumentResponse } from '../shared/types/ipc'
